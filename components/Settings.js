...
function Settings()  {
  ...
  const cacheTheme = async (item) => {
    try {
      await AsyncStorage.setItem('Theme', item);
      setTheme(item)
      console.log("Item with Theme " + item + " successfully cached.")
    } 
    catch (error) {
  ...
  useEffect(() => {
    ...
    return (
      <View style={Theme=='Dark'? styles.MainContainer_dark : styles.MainContainer}>
        ...
        <View style={Theme=='Dark'? styles.bodyContainer_dark : styles.bodyContainer}>
          <Text style={Theme=='Dark'? styles.bodyText_dark : styles.bodyText}>Theme</Text>
          <Text style={styles.settingText}>
            ...
            onChange={item => {
              cacheTheme(item.value)
              setIsFocus(false);
            }}
            />
          </Text>

          <Text style={Theme=='Dark'? styles.bodyText_dark : styles.bodyText}>Sort Favorites by:</Text>
           <Text style={styles.settingText}>
        ...
        <View style={Theme=='Dark'? styles.smallerbodyContainer_dark : styles.smallerbodyContainer}>
          <Text style={Theme=='Dark'? styles.bodyText_dark : styles.bodyText}>Clear all cache</Text>
